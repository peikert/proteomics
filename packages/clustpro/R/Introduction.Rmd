...
db_object <- get_best_k(matrix = df_data, min_k = 2, max_k = 10, method = 'kmeans', seed = seed, cores = 4)
...
df_data_extended <- order_dataframe_by_list(df_data_extended,order.dendrogram(row_dend),'clusterVector')
